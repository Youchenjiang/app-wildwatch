 ...
 * encoding (rule 8): sustains both species for 30,000+ ticks under
 * terminal-extinction rules with the carrion cycle active. Re-validate
 * whenever an ecosystem mechanic changes.
 */
